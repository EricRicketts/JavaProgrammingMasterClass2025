...
public class RectangleTest {
    ...
    private final String literalWidth = "width";
    private final String literalHeight = "height";
    ...
    class ConstructorWidthTests {
        ...
        public void testRectangleConstructorRejectsNullValueForWidth() {
            assertEquals(
                    ErrorMessages.nullValue(literalWidth),
                    assertThrows(
        ...
        public void testRectangleConstructorRejectsZeroValueForWidth() {
            assertEquals(
                    ErrorMessages.zeroValue(literalWidth),
                    assertThrows(
        ...
        public void testRectangleConstructorRejectsNegativeValueForWidth() {
            assertEquals(
                    ErrorMessages.negativeValue(literalWidth),
                    assertThrows(
                            IllegalArgumentException.class,
    ...
    class ConstructorHeightTests {
        ...
        public void testRectangleConstructorRejectsNullValueForHeight() {
            assertEquals(
                    ErrorMessages.nullValue(literalHeight),
                    assertThrows(
                            NullPointerException.class,
        ...
        public void testRectangleConstructorRejectsZeroValueForHeight() {
            assertEquals(
                    ErrorMessages.zeroValue(literalHeight),
                    assertThrows(
                            IllegalArgumentException.class,
        ...
        public void testRectangleConstructorRejectsNegativeValueForHeight() {
            assertEquals(
                    ErrorMessages.negativeValue(literalHeight),
                    assertThrows(
                            IllegalArgumentException.class,
